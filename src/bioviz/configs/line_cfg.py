...
class LinePlotConfig(BasePlotConfig):
    ...
    xtick_rotation: Annotated[int | None, Field(default=None)]
    xtick_rotation_mode: Annotated[str, Field(default="anchor")]
    xtick_rotation_ha: Annotated[str, Field(default="right")]
