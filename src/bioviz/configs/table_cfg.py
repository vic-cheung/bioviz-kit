...
class StyledTableConfig(BaseModel):
    ...
    title_font_size: Annotated[float | int, Field(default=20)]
    ...
    row_height: Annotated[float, Field(default=0.06)]
    header_row_height: Annotated[float | None, Field(default=None)]
    row_height_multiplier: Annotated[float, Field(default=1.0)]
    table_width: Annotated[float, Field(default=2.5)]
    table_scale: Annotated[tuple[float, float], Field(default=(12, 12))]
    absolute_font_size: Annotated[bool, Field(default=False)]
